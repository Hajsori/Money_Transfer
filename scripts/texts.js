const en = {
    ...
    greetingDefault: "",
    enterValidNumber: "§r§8[§aMoney §eTransfer§8] §cPlease enter a valid Amount!§r",
    notEnoughMoney: "§r§8[§aMoney §eTransfer§8] §cYou don't have enough Money!§r",
    withGreet: " with this greeting: §7{greet}",
...
const de = {
    ...
    greetingDefault: "",
    enterValidNumber: "§r§8[§aMoney §eTransfer§8] §cBitte wähle einen gültigen Betrag aus!§r",
...
const ru = {
    ...
    withGreet: " Он также отправил вам комментарий: §7{greet}",
